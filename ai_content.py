...
def save_used_anime(anime_set):
    # Храним последние 100 названий, чтобы не разрастался
...
def generate_content():
    ...
    last_good = None  # последний удачный вариант
...
"""
        try:
            ...
            last_good = (title, body)  # сохраняем как запасной
    ...
    # Если после всех попыток не нашли уникальный, публикуем последний удачный
    if last_good:
